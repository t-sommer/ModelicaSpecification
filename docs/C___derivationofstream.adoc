...
image::fluidmix.png[caption="Exemplary connection set with three connected components and a common mixing enthalpy."]
...
image::fluidmix3.png[caption="Exemplary connection set with three connected components."]
...
image::fluidmix4.png[caption="Example series connection of multiple models with stream connectors."]
