...
|`cardinality(c)` |Number of occurrences in `connect`-equations |<<cardinality-deprecated>>
...
|`sample(start, interval)` |Periodic triggering of events |<<sample>>
