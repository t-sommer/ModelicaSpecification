...
image::piecewise-constant.png[caption="A piecewise-constant variable."]
...
image::clock.png[caption="A clock variable. The value of a clock variable is not defined -- the plot marks only indicate when the clock is active."]
...
image::clocked.png[caption="A clocked variable. The hold extrapolation of the value at the last event instant is illustrated with dashed green lines."]
