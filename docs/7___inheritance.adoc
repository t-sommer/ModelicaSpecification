...
[cols="13*^a",options=autowidth]
|===
|Derived Class |pack-age |oper-ator |func-tion |opera-tor func-tion |type |re-cord |opera-tor record |expan-dable con-nector |con-nector |block |mo-del |class
